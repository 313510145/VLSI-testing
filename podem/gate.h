...
class GATE {
    ...
    public:
        //Initialize GATE
        GATE(): ID(0), Function(G_BAD), Level(0), Value(X), Value_t(X), Value_3(X_3), Inversion(false) {
        ...
        void SetValue_3(const bitset<2>& v) { Value_3 = v; }
        ...
        unsigned GetCount(unsigned i = 0) const { return Count[i]; }
        string GetName() const { return Name; }
        unsigned GetID() const { return ID; }
        GATEFUNC GetFunction() const { return Function; }
        unsigned No_Fanin() const { return Input_list.size(); }
        unsigned No_Fanout() const { return Output_list.size(); }
        ...
        VALUE GetValue_t() const { return Value_t; }
        bitset<2> GetValue_3() const { return Value_3; }
        ...
        bool GetFlag(FLAGS f) const { return Flag[f]; }
        bool Is_Inversion() const { return Inversion;}
        ...
        void SetValue1(const bitset<PatternNum> &value) { WireValue[0] = value; }
        ...
        bool GetValue1(unsigned idx) const { return WireValue[0][idx]; }
        bitset<PatternNum> GetValue1() const { return WireValue[0]; }
        void SetValue2(const bitset<PatternNum> &value) { WireValue[1] = value; }
        ...
        bool GetValue2(unsigned idx) const { return WireValue[1][idx]; }
        bitset<PatternNum> GetValue2() const { return WireValue[1]; }
        void ParallelInv() {
        ...
        bool GetFaultFlag(unsigned idx) const { return FaultFlag[idx]; }
        ...
        void SetWireValue(unsigned i, const bitset<PatternNum> &value) { WireValue[i] = value; }
        ...
        bool GetWireValue(unsigned i, unsigned idx) const { return WireValue[i][idx]; }
        bitset<PatternNum> GetWireValue(unsigned i) const { return WireValue[i]; }
        char GetTransition_t() const {
            if (Value == S0) {
                if (Value_t == S0) {
                    return '0';
                }
