...
template <class KEY, class VALUE, class HASH_FUNCTION>
int Hash<KEY, VALUE, HASH_FUNCTION>::bucket_num(KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return (-1);
...
template <class KEY, class VALUE, class HASH_FUNCTION>
int Hash<KEY, VALUE, HASH_FUNCTION>::test_insert(KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return b;
...
template <class KEY, class VALUE, class HASH_FUNCTION>
int Hash<KEY, VALUE, HASH_FUNCTION>::insert(const KEY k, const VALUE v) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
...
template <class KEY, class VALUE, class HASH_FUNCTION>
void Hash<KEY, VALUE, HASH_FUNCTION>::forced_insert(const int b, const KEY k, const VALUE v) {
    pair<KEY, VALUE> p = make_pair(k, v);
    bucket[b].push_back(p);
    num_of_nodes++;
}
...
template <class KEY, class VALUE, class HASH_FUNCTION>
int Hash<KEY, VALUE, HASH_FUNCTION>::is_member(KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return 0;
...
template <class KEY, class VALUE, class HASH_FUNCTION>
VALUE Hash<KEY, VALUE, HASH_FUNCTION>::pop_value(KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return VALUE(0);
...
template <class KEY, class VALUE, class HASH_FUNCTION>
VALUE Hash<KEY, VALUE, HASH_FUNCTION>::get_value(KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return VALUE(0);
...
template <class KEY, class VALUE, class HASH_FUNCTION>
VALUE Hash<KEY, VALUE, HASH_FUNCTION>::get_value(KEY k, int b) {
    if (b >= _size || b < 0) {
...
template <class KEY, class VALUE, class HASH_FUNCTION>
int Hash<KEY, VALUE, HASH_FUNCTION>::remove(KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return 0;
...
template <class KEY, class VALUE, class HASH_FUNCTION>
unsigned Hash<KEY, VALUE, HASH_FUNCTION>::remove_if(Pred<VALUE> *pred) {
...
template <class KEY, class VALUE, class HASH_FUNCTION>
unsigned Hash<KEY, VALUE, HASH_FUNCTION>::remove_if_else(Pred<VALUE> *pred, Exec<VALUE> *e) {
    unsigned total_removed = 0;
    for (int b = 0; b < _size; b++) {
        if (bucket[b].empty()) {
            continue;
...
template <class KEY, class VALUE, class HASH_FUNCTION>
void Hash<KEY, VALUE, HASH_FUNCTION>::clean() {
    num_of_nodes = 0;
    for (int b = 0; b < _size; b++) {
...
template <class KEY, class VALUE, class HASH_FUNCTION>
VALUE Hash<KEY, VALUE, HASH_FUNCTION>::operator[] (KEY k) {
    HASH_FUNCTION f;
    int b = f(k, _size);
    if (bucket[b].empty()) {
        return VALUE(0);
...
template <class KEY, class VALUE, class HASH_FUNCTION>
void Hash<KEY, VALUE, HASH_FUNCTION>::for_each_exec(Exec<VALUE> *e) {
    for (int b = 0; b < _size; b++) {
        if (bucket[b].empty()) {
            continue;
        }
...
template <class KEY, class VALUE, class HASH_FUNCTION>
void Hash<KEY, VALUE, HASH_FUNCTION>::for_each_if_else(Pred<VALUE> *pred, Exec<VALUE> *if_e, Exec<VALUE> *else_e) {
    for (int b = 0; b < _size; b++) {
        if (bucket[b].empty()) {
            continue;
        }
